...
public class Helper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_TABLE_USER_STATEMENT = "CREATE TABLE" + Contract.User.TABLE_NAME + "("
                + Contract.User._ID + Contract.DATA_INTEGER + Contract.CONSTRAINT_PRIMARY_KEY + ","
        ...
        final String SQL_CREATE_TABLE_FRIEND_STATEMENT = "CREATE TABLE" + Contract.Friend.TABLE_NAME + "("
                ...
                + Contract.Friend.COLUMN_FRIEND_STATE + Contract.DATA_INTEGER + Contract.CONSTRAINT_DEFAULT + FriendState.NORMAL + ");";
